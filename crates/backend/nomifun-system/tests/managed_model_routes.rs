...
use nomifun_system::{
    ...
    VersionCheckService, start_and_provision_free_model, system_routes,
};
...
async fn setup() -> (axum::Router, nomifun_db::Database, ManagedModelServer) {
...
#[tokio::test]
async fn status_and_local_placeholder_match_wire_contract() {
    ...
    assert_eq!(local["data"]["availability"], "planned");
}
